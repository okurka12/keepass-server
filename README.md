...
On the other hand, Keepass2Android 1.14-r1 only does:
```
GET  /passwords-personal.kdbx              HTTP/1.0" 200 -
PUT  /passwords-personal.kdbx.tmp.12533843 HTTP/1.0" 200 -
MOVE /passwords-personal.kdbx.tmp.12533843 HTTP/1.0" 200 -
```
